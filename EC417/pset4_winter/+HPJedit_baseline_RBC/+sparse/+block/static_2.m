...
residual=NaN(9, 1);
  residual(1)=(y(4))-((y(3)/y(8))^params(7));
  T(2)=(y(9)*y(5))^params(4);
  T(3)=y(4)^(1-params(4));
  residual(2)=(y(7))-(y(1)*T(2)*T(3));
  residual(3)=(y(7))-(y(8)+y(6));
  residual(4)=(y(5))-(y(6)+y(5)*(1-y(10)));
  residual(5)=(1/y(8))-(1/y(8)*params(1)*(1+y(2)*y(9)-y(10)));
  T(4)=y(1)*params(4)*(y(9)*y(5))^(params(4)-1);
  residual(6)=(y(2))-(T(3)*T(4));
  residual(7)=(y(2))-(params(2)*params(6)*y(9)^(params(6)-1));
  T(5)=y(4)^(-params(4));
  residual(8)=(y(3))-(T(2)*y(1)*(1-params(4))*T(5));
...
g1_v(1)=(-(1/y(8)*T(6)));
g1_v(2)=1;
g1_v(3)=(-(T(3)*y(1)*y(9)*T(8)));
g1_v(4)=1-(1-y(10));
g1_v(5)=(-(T(3)*y(1)*params(4)*y(9)*T(9)));
g1_v(6)=(-(T(5)*y(1)*(1-params(4))*y(9)*T(8)));
g1_v(7)=1;
g1_v(8)=1;
g1_v(9)=(-1);
g1_v(10)=(-1);
g1_v(11)=(-(T(6)*(-y(3))/(y(8)*y(8))));
g1_v(12)=(-1);
g1_v(13)=(-1)/(y(8)*y(8))-params(1)*(1+y(2)*y(9)-y(10))*(-1)/(y(8)*y(8));
g1_v(14)=(-(T(3)*y(1)*y(5)*T(8)));
g1_v(15)=(-(1/y(8)*params(1)*y(2)));
g1_v(16)=(-(T(3)*y(1)*params(4)*y(5)*T(9)));
g1_v(17)=(-(params(2)*params(6)*getPowerDeriv(y(9),params(6)-1,1)));
g1_v(18)=(-(T(5)*y(1)*(1-params(4))*y(5)*T(8)));
g1_v(19)=(-(params(2)*getPowerDeriv(y(9),params(6),1)));
g1_v(20)=(-(1/y(8)*params(1)*y(9)));
g1_v(21)=1;
g1_v(22)=1;
g1_v(23)=1;
g1_v(24)=(-(y(1)*T(2)*T(7)));
g1_v(25)=(-(T(4)*T(7)));
g1_v(26)=(-(T(2)*y(1)*(1-params(4))*getPowerDeriv(y(4),(-params(4)),1)));
g1_v(27)=y(5);
g1_v(28)=(-(1/y(8)*(-params(1))));
g1_v(29)=1;
